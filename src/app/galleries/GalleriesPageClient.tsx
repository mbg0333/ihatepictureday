...
import { ExternalLink, Play, Tag, Camera, Clock } from "lucide-react";
          ...
          samples.map((img, idx) => {
            ...
            return (
              ...
              >
                <img 
                  src={img} 
                  alt="Sports athlete gallery sample pose" 
...
export default function GalleriesPageClient() {
              ...
              <div className="bg-zinc-900 p-8 border border-white/5">
                ...
                <div className="aspect-video relative bg-brand-black border border-white/10 overflow-hidden mb-6 group cursor-pointer">
                  <video 
                    ...
                    controls
                    title="PhotoDay athlete photo ordering tutorial video"
                  />
                </div>
